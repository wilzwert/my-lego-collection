 ...
 */
#[AsMessageHandler]
readonly class UserSetCreatedEventHandler implements DomainEventHandler
{
    public function __construct(private UserSetCreatedOrchestrator $userSetCreatedOrchestrator)
    {
    }

    public static function getMessageHandled(): string
    {
        return UserSetCreatedEvent::class;
    }

    public function __invoke(UserSetCreatedEvent $setCreatedEvent): void
    {
        ($this->userSetCreatedOrchestrator)($setCreatedEvent);
    }
}
