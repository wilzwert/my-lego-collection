...
class UserSetCollectionTest extends TestCase
{
    ...
    {
        $localSet1 = new Set(EntityId::fromString(self::$uuids['localSetId1']), 'external-123', 'lego-123', 'Star Wars Superstar Destroyer', 1000, '/images/destroyer.png', 2011);
        $localSet2 = new Set(EntityId::fromString(self::$uuids['localSetId2']), 'external-456', 'lego-456', 'Star Wars Death Star', 1500, '/images/death.png', 2010);
