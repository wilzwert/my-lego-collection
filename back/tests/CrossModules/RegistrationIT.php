...
namespace App\Tests\CrossModules;
 ...
 */
class RegistrationIT extends WebTestCase
{

    use WebTestCaseAuthenticateUserTrait;

    private const string USER_EMAIL = 'integrationregistration@example.com';
    private const string USER_USERNAME = 'integration-registration';
    ...
    public function shouldRegisterAndTriggerEvents(): void
    {
        ...
        //      TODO : maybe we should find a way to actually test that the user is asynchronously, although it could be unreliable in a test environment
        //        // then, an event MUST have triggered the User creation command (asynchronously)
